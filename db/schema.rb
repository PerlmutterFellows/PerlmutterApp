...
ActiveRecord::Schema.define(version: 2020_07_19_213946) do
  ...
  create_table "event_statuses", force: :cascade do |t|
    ...
    t.index ["event_id", "user_id"], name: "index_event_statuses_on_event_id_and_user_id", unique: true
  end
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.time "endTime"
    t.string "location"
    t.integer "eventType", default: 0, null: false
  ...
  create_table "subscores", force: :cascade do |t|
