class GroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      if @group.save
        flash.now.notice = t('global.model_created', type: t('global.group').downcase)
  ...
  def update
    respond_to do |format|
      ...
      if @group.update({name: params['group']['name']})
          flash.now.notice = t('global.model_modified', type: t('global.group').downcase)
          format.html { redirect_to @group }
  ...
  def destroy
    @group.destroy
    respond_to do |format|
      flash.now.notice = t('global.model_deleted', type: t('global.group').downcase)
